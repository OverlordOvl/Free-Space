...
class AppStorage:
    ...
    def __init__(self):
        ...
        self.ssl_keys_path = os.path.join(self.path, 'ssl')
        self.app_data_path = os.path.join(self.path, 'app_data')

        self.media_path = os.path.join(self.path, 'media')
        self.audio_path = os.path.join(self.media_path, 'audio')
        self.photo_path = os.path.join(self.media_path, 'photo')
        self.video_path = os.path.join(self.media_path, 'video')

        self.other_content_path = os.path.join(self.media_path, 'other')

        self.path_collections = {
            'root':  self.media_path,
            'audio': self.audio_path,
            'photo': self.photo_path,
            'video': self.video_path,
            'other': self.other_content_path,
            'ssl':   self.ssl_keys_path,
        }
